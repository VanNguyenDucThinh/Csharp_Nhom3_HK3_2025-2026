...
const USE_MOCK = false; // <-- set true để dùng dữ liệu mock, false để gọi API backend

const mockPlaylists: Playlist[] = [
  { id: "1", name: "Nhạc yêu thích", owner: "1", track: [] },
  { id: "2", name: "Chill Vibes", owner: "1", track: [] },
  { id: "3", name: "Workout Mix", owner: "1", track: [] },
  { id: "4", name: "V-Pop Hot", owner: "1", track: [] },
  { id: "5", name: "Study Lofi", owner: "1", track: [] },
  { id: "6", name: "Top Hits 2025", owner: "1", track: [] },
  { id: "7", name: "Lo-fi Beats", owner: "1", track: [] },
  { id: "8", name: "Indie Vibes", owner: "1", track: [] },
];
  ...
  useEffect(() => {
    const load = async () => {
      ...
      try {
        ...
        setPlaylists(pls);
        // Convert HistoryMediaDto[] → MediaDto[]
        const tracks: MediaItem[] = historyItems.map((h) => ({
          id: h.idMedia,
          title: h.title,
          artist: h.artist,
          urlMedia: "",
